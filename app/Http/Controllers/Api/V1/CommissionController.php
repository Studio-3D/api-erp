        ...
        if (RoleHelper::AdminSup()) {
            ...
            if (count($users_has_commission_mensuelle_cette_mois) > 0) {
                foreach ($users_has_commission_mensuelle_cette_mois as $us) {
                    array_push($array1, ['user_id' => $us->user_id]);
                }
            }
            ...
            if (count($users) > 0) {
                foreach ($users as $us) {
                    array_push($array2, ['user_id' => $us->user_id]);
                }
            }
            ...
            if (count($unique_user_ids) > 0) {
                foreach ($unique_user_ids as $us_id) {
                    ...
                    if ($nb_vente > 0) {
                        ...
                        array_push($users_with_data_vente, ['id' => $us_id, 'name' => $name, 'prenom' => $prenom, 'nb_vente' => $nb_vente, 'commission' => $commission]);
                    }
                }
            }
