...
class ReservationController extends Controller
{
    ...
    public function index()
    {
        if(Auth::guard('api')->check()){
            ...
            $reservations=Reservation::on('temp')->get();
    ...
    public function store(StoreReservationRequest $request)
    {
        ...
        if(RoleHelper::ACSup())
        {
            ...
            if(RoleHelper::AdminSup()){
                $reservation->statut=Statut::VALIDER->value;
            }
            if(RoleHelper::Com()){
                $reservation->statut=Statut::EN_ATTEND->value;
            }
            if($reservation->save()){
    ...
    public function destroy($id)
    {
        if(RoleHelper::ACSup()){
            ...
            $aquereurController = new AquereurController();
            $aquereurController->destoryAquereurUsingReservationId($id);
