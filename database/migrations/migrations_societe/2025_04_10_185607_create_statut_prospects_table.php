...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('statut_prospects', function (Blueprint $table) {
            ...
            $table->enum('statut',[StatutProspectEnum::Planification_rdv->value,StatutProspectEnum::Injoignable->value,StatutProspectEnum::Rappel->value])->comment('1=>Planification_rdv 2=>Injoignable 3=>Rappel');
